...
<head>
	...
	<title>Crear Administrador</title> <!-- titulo que aparecerá en la pestaña-->
</head>
<body>
<table id="main"> 
	<tr><td>
	...
	$rs=mysqli_query($conexion, "SELECT MAX(idAdmin) AS idAdmin FROM admin");
	if ($row = mysqli_fetch_array($rs)) {
		$idAdmin = trim($row[0]+1); //al proximo id se le sumará un número
		...
		if(isset($_POST['crear'])){
			...
			$sql="INSERT INTO admin (idAdmin, nombre, apellido, correo, cedula, genero, lugarNac, fechaNac, telefono, direccion, cargo) VALUES ('$idAdmin', '$nombre', '$apellido', '$correo', '$cedula', '$genero', '$lugarNac', '$fechaNac', '$telefono', '$direccion', '$cargo')";
				...
				<table >	<!-- tabla para encerrar el formulario -->
					<tr bgcolor="green">
						<td colspan="2"> <!-- cospan hará que el td ocupe dos columnas -->
							<center> <h2> .:Agregar Administrador:. </h2> </center>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="cargo" size="25">
						</td>
					</tr>
					<tr>
						<td colspan="2">
