...
<head>
	...
	<title>Editar Estudiante</title> <!-- titulo que aparecerá en la pestaña-->
...
<table id="main"> 
	...
	<?php 
		...
		$sql = "SELECT * FROM estudiante WHERE idAlumno = '$idAlumno'";
...
<center>
	<form method="POST" action="actualizarAlumno.php"> <!-- metodo con el que se enviarán los datos -->
				...
				<td>
					<table >	<!-- tabla para encerrar el formulario -->
						...
						<tr>
							...
							<td>
								<input type="text" name="documento" size="25" value="<?php echo $datos['idAlumno'] ?>" readonly>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="grado" size="25" value="<?php echo $datos['grado'] ?>">
							</td>
						</tr>
						<tr>
							<td colspan="2">
