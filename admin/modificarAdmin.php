...
<head>
	...
	<title>Editar Administrador</title> <!-- titulo que aparecerá en la pestaña-->
...
<center>
	<form method="POST" action="actualizarAdmin.php"> <!-- metodo con el que se enviarán los datos -->
				...
				<td>
					<table >	<!-- tabla para encerrar el formulario -->
						...
						<tr>
							...
							<td>
								<input type="text" name="idAdmin" value="<?php echo $datos['idAdmin'] ?>" size="25" readonly> <!--campo donde se escribe -->
							</td>	
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" name="cedula" size="25" value="<?php echo $datos['cedula'] ?>">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="cargo" size="25" value="<?php echo $datos['cargo'] ?>">
							</td>
						</tr>
						<tr>
							<td colspan="2">
