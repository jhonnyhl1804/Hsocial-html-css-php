...
<table id="main"> 
	...
	//	$idProfesor = trim($row[0]+1); //al proximo id se le sumará un número
		...
		if(isset($_POST['crear'])){
			...
			$sql="INSERT INTO estudiante (idAlumno, nombre, apellido, correo, genero, lugarNac, fechaNac, telefono, direccion, grado) VALUES ('$documento', '$nombre', '$apellido', '$correo', '$genero', '$lugarNac', '$fechaNac', '$telefono', '$direccion', '$grado')";
				...
				<table >	<!-- tabla para encerrar el formulario -->
					<tr bgcolor="green">
						<td colspan="2"> <!-- cospan hará que el td ocupe dos columnas -->
							<center> <h2> .:Agregar Estudiante:. </h2> </center>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="documento" size="25">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="grado" size="25">
						</td>
					</tr>
					<tr>
						<td colspan="2">
